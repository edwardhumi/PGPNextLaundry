      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>R1 Dryer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='R1' machine='D1' />
      <Laundry color='#FF7377' block='R1' machine='D2' />
      <Laundry color='#FF7377' block='R1' machine='D3' />
    </ScrollView>
  );
};
