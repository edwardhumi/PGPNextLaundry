      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>HH Dryer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='HH' machine='D1' />
      <Laundry color='#FF7377' block='HH' machine='D2' />
      <Laundry color='#FF7377' block='HH' machine='D3' />
    </ScrollView>
  );
};
