      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>PH Washer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='PH' machine='W1' />
      <Laundry color='#FF7377' block='PH' machine='W2' />
      <Laundry color='#FF7377' block='PH' machine='W3' />
    </ScrollView>
  );
};
