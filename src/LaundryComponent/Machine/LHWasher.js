      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>LH Washer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='LH' machine='W1' />
      <Laundry color='#FF7377' block='LH' machine='W2' />
      <Laundry color='#FF7377' block='LH' machine='W3' />
    </ScrollView>
  );
};
