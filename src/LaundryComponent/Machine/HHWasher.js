      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>HH Washer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='HH' machine='W1' />
      <Laundry color='#FF7377' block='HH' machine='W2' />
      <Laundry color='#FF7377' block='HH' machine='W3' />
    </ScrollView>
  );
};
