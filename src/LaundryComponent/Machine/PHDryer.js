      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>PH Dryer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='PH' machine='D1' />
      <Laundry color='#FF7377' block='PH' machine='D2' />
      <Laundry color='#FF7377' block='PH' machine='D3' />
    </ScrollView>
  );
};
