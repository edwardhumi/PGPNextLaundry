      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>R3 Washer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='R3' machine='W1' />
      <Laundry color='#FF7377' block='R3' machine='W2' />
      <Laundry color='#FF7377' block='R3' machine='W3' />
    </ScrollView>
  );
};
