      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>LH Dryer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='LH' machine='D1' />
      <Laundry color='#FF7377' block='LH' machine='D2' />
      <Laundry color='#FF7377' block='LH' machine='D3' />
    </ScrollView>
  );
};
