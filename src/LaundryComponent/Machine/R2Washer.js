      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>R2 Washer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='R2' machine='W1' />
      <Laundry color='#FF7377' block='R2' machine='W2' />
      <Laundry color='#FF7377' block='R2' machine='W3' />
    </ScrollView>
  );
};
