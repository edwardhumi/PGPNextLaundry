      ...
      <View style={styles.backButtonContainer}>
        ...
        <View style={styles.centeredContainer}>
          <View style={styles.washerContainer}>
            <Text style={styles.washerText}>R3 Dryer</Text>
          </View>
        </View>
      </View>
      <Laundry color='#FF7377' block='R3' machine='D1' />
      <Laundry color='#FF7377' block='R3' machine='D2' />
      <Laundry color='#FF7377' block='R3' machine='D3' />
    </ScrollView>
  );
};
